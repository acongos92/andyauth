...
// WithLogin adds the login to the create user params
func (o *CreateUserParams) WithLogin(login *models.Login) *CreateUserParams {
	o.SetLogin(login)
	return o
}

// SetLogin adds the login to the create user params
func (o *CreateUserParams) SetLogin(login *models.Login) {
	o.Login = login
}
