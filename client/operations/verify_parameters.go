...
// WithToken adds the token to the verify params
func (o *VerifyParams) WithToken(token *models.Token) *VerifyParams {
	o.SetToken(token)
	return o
}

// SetToken adds the token to the verify params
func (o *VerifyParams) SetToken(token *models.Token) {
	o.Token = token
}
