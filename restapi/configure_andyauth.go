...
import (
	...
	"github.com/acongos92/andyauth/restapi/operations"
)

//go:generate swagger generate server --target ..\..\andyauth --name Andyauth --spec ..\swagger.yml

func configureFlags(api *operations.AndyauthAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.AndyauthAPI) http.Handler {
